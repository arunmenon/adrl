...
- middle-band turns with embeddings: 98
- graduation needs: >= 300 middle-band decisions
- evaluated (non-abstained): 42  (coverage 43%, abstained 56)
...
## verdict: INSUFFICIENT DATA — 202 more middle-band decisions needed
The matrix above is a preview, not a graduation decision. Keep the flywheel running; re-run this report as the middle band grows.
