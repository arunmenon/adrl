...
- evaluated (non-abstained): 34  (coverage 34%, abstained 66)

## preview confusion matrix (leave-one-out)

| | actual hard | actual easy |
|--|--:|--:|
| **predicted frontier** | 0 (TP) | 1 (FP) |
| **predicted local** | 0 (FN) | 33 (TN) |

- accuracy: 97%
- frontier recall: 0% (of turns that really went hard, how many it would send to frontier)
- frontier send-rate: 3%  (baseline always-local = 0%, always-frontier = 100%)
...
## verdict: INSUFFICIENT DATA - 266 more EVALUATED middle-band decisions needed
